      ...
      <div className="order-1 md:order-2 space-y-8">
        <div className="animate-about-block">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            At <strong>Greenwave Packaging</strong>, our mission is simple: to
            lead the packaging industry into a sustainable future. We are
            dedicated to providing innovative, high-performance films, resins,
            and containers that meet the rigorous demands of global commerce
            while significantly reducing environmental impact. We believe profit
            and planet can, and must, coexist.
          </p>
        </div>
