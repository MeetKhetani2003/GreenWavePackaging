      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="about-text-block space-y-6 md:w-1/2">
            ...
            <Link
              href={"/contact"}
              className="mt-8 px-8 py-3 bg-green-600 hover:bg-green-700 transition-colors duration-300 text-lg font-semibold text-white rounded-lg shadow-xl transform hover:scale-[1.02] active:scale-95"
            >
              Contact Us Today
            </Link>
          </div>
