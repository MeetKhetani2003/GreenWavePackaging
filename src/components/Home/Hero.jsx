      ...
      <div className="relative z-10 flex items-center justify-center h-full text-white text-center px-4">
        <div className="max-w-4xl space-y-6">
          ...
          <div className="space-x-3">
            <Link
              href={"/product"}
              className="hero-button mt-8 px-10 py-4 bg-green-600 hover:bg-green-700 transition-colors duration-300 text-lg font-semibold rounded-md shadow-2xl transform hover:scale-105 active:scale-95"
            >
              Explore Products
            </Link>
            <Link
              href={"/contact"}
              className="hero-button mt-8 px-10 py-4 bg-orange-500 hover:bg-orange-700 transition-colors duration-300 text-lg font-semibold rounded-md shadow-2xl transform hover:scale-105 active:scale-95"
            >
              Contact Us
            </Link>
          </div>
